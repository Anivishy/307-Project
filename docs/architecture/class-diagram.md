...
This class diagram reflects the current Prisma data model used by the backend services. The source file is committed at [class-diagram.mmd](class-diagram.mmd).
